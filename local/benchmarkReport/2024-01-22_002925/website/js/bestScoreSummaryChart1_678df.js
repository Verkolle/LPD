...
var chart_bestScoreSummaryChart1_678df = new Chart(document.getElementById('chart_bestScoreSummaryChart1_678df'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart1_678df.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart1_678df.resize();
});