...
var chart_bestScoreSummaryChart1_6c034 = new Chart(document.getElementById('chart_bestScoreSummaryChart1_6c034'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart1_6c034.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart1_6c034.resize();
});