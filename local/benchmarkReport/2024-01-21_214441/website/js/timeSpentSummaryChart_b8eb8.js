...
var chart_timeSpentSummaryChart_b8eb8 = new Chart(document.getElementById('chart_timeSpentSummaryChart_b8eb8'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentSummaryChart_b8eb8.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentSummaryChart_b8eb8.resize();
});