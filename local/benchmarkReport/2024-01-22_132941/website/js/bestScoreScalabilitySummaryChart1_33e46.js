...
var chart_bestScoreScalabilitySummaryChart1_33e46 = new Chart(document.getElementById('chart_bestScoreScalabilitySummaryChart1_33e46'), {
    type: 'line',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreScalabilitySummaryChart1_33e46.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreScalabilitySummaryChart1_33e46.resize();
});
