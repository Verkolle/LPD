...
var chart_timeSpentSummaryChart_c7bb7 = new Chart(document.getElementById('chart_timeSpentSummaryChart_c7bb7'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentSummaryChart_c7bb7.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentSummaryChart_c7bb7.resize();
});