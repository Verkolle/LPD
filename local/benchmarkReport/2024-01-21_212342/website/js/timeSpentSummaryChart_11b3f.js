...
var chart_timeSpentSummaryChart_11b3f = new Chart(document.getElementById('chart_timeSpentSummaryChart_11b3f'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentSummaryChart_11b3f.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentSummaryChart_11b3f.resize();
});