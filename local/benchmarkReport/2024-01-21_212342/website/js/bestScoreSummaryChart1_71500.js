...
var chart_bestScoreSummaryChart1_71500 = new Chart(document.getElementById('chart_bestScoreSummaryChart1_71500'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart1_71500.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart1_71500.resize();
});